...
public class Main {
    private static Logger loggerCorrectInput;
    ...
    public static void main(String[] args) {
        ...
        loggerCorrectInput = LogManager.getLogger("input_correct");
        loggerErrorInput = LogManager.getLogger("input_errors");
        loggerError = LogManager.getLogger("exceptions");
    ...
    private static Station takeStation(String message) {
        for (; ; ) {
            ...
            if (station != null) {
                loggerCorrectInput.info("Станция найдена: " + line);
                return station;
            }

            loggerErrorInput.info("Станция не найдена: " + line);
